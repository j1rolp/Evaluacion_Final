...
public final class FragmentListBinding implements ViewBinding {
  ...
  private FragmentListBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView rvList) {
  ...
  public static FragmentListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentListBinding((ConstraintLayout) rootView, rvList);
    }
