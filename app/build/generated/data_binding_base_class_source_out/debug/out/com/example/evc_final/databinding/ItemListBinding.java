...
public final class ItemListBinding implements ViewBinding {
  ...
  private ItemListBinding(@NonNull CardView rootView, @NonNull TextView altura,
      @NonNull ImageView imagenView, @NonNull TextView nameTitan) {
  ...
  public static ItemListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemListBinding((CardView) rootView, altura, imagenView, nameTitan);
    }
